...
urlpatterns = [
    ...
    path('ajouterAuFavories/<str:idArticle>/',views.AjouterAuFavoriesView.as_view(), name='ajouterAuFavories'),
    path('supprimerDuFavories/<str:idArticle>/',views.SupprimerDuFavoriesView.as_view(), name='supprimerDuFavories'),
